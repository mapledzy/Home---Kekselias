      ...
      <section className="c-sidebar u-fadeInleftBig" data-widget="menu" data-wow-delay="0.3s">
        <figure className="c-sidebar-logo">
          <a href="https://github.com/mapledzy/Home---Kekselias" data-route="hemo" >
            ...
            <img className="c-sidebar-logo-mobile" src={imgbase64} alt="1" />
            {/* eslint-enable global-require, max-len */}
          </a>
        </figure>
        <nav className="c-sidebar-menu">
          <a ref={(a) => { this.menu = a; }} href="Elting-Memorial" className="c-sidebar-labelmobile" onClick={this.open}>
            Menu
            <span ref={(span) => { this.menubar = span; }} className="c-sidebar-menubar" />
          </a>
          <ul ref={(ul) => { this.ul = ul; }} className="c-sidebar-submenu">
